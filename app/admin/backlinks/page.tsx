...
export default function BacklinksPage() {
  ...
  return (
    <div className="p-8 flex-1">
      <div className="mb-8">
        <h1 className="font-bebas text-5xl tracking-wide text-text mb-1">Backlinks & Guest Posts</h1>
        <p className="text-text-muted text-sm">Gerencie construcao de backlinks e outreach.</p>
      </div>
      ...
      {activeTab === 'dashboard' && (
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white rounded-xl border border-border p-6">
              <p className="text-sm text-text-muted mb-1">Dominios Unicos</p>
              <p className="font-bebas text-3xl text-text">--</p>
              <p className="text-xs text-text-muted">Configure API para dados</p>
            </div>
            <div className="bg-white rounded-xl border border-border p-6">
              <p className="text-sm text-text-muted mb-1">DA Medio</p>
              <p className="font-bebas text-3xl text-text">--</p>
              <p className="text-xs text-text-muted">Configure API para dados</p>
            </div>
            <div className="bg-white rounded-xl border border-border p-6">
          ...
          {/* Quick Actions */}
          <div className="bg-white rounded-xl border border-border p-6">
            <h2 className="font-syne font-bold text-lg text-text mb-4">Acoes Rapidas</h2>
          ...
          <div className="bg-white rounded-xl border border-border p-6">
            ...
            <p className="text-sm text-text-muted mb-4">
              Sites para contato para publicacao de artigos:
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-3 px-4 font-medium text-text-muted">Dominio</th>
                    ...
                    <th className="text-left py-3 px-4 font-medium text-text-muted">Acao</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-border">
      ...
      {activeTab === 'outreach' && (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-border p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="font-syne font-bold text-lg text-text">Template de Pagina de Recursos</h2>
              <button
      ...
      {activeTab === 'audit' && (
        <div className="space-y-6">
          ...
          <div className="bg-blue/5 rounded-xl border border-blue/20 p-6">
            <h3 className="font-syne font-bold text-text mb-2">Dicas para Construcao de Backlinks</h3>
            <ul className="space-y-2 text-sm text-text-2">
              <li>• Crie conteudo de alta qualidade que seja naturalmente compartilhavel</li>
              <li>• Participe de foruns e comunidades do seu nicho</li>
              <li>• Ofereca guest posts para sites relevantes</li>
              <li>• Use o skyscraper technique: encontre conteudo popular e crie algo melhor</li>
              <li>• Monitore mencoes a sua marque e pecam links quando nao estiverem presentes</li>
              <li>• Evite praticas de black hat SEO (compra de links, spam, etc.)</li>
            </ul>
          </div>
        </div>
      )}
