    ...
    <div className="space-y-4">
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-surface border border-border rounded-xl pl-10 pr-4 py-3 text-sm text-ink placeholder:text-muted focus:outline-none focus:border-blue transition-colors"
        />
      </div>
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-colors ${
            !category
              ...
              : "bg-surface text-muted border-border hover:border-blue/50"
          }`}
        >
          Todos
        </button>
      ...
      {hasActiveFilters && (
        <div className="flex items-center gap-2">
          ...
          {search && (
            <span className="inline-flex items-center gap-1 bg-surface2 text-xs text-ink px-2 py-1 rounded-full">
              &quot;{search}&quot;
              <button
                onClick={() => {
                  setSearch("");
