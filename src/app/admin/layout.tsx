...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] flex">
      <aside className="hidden md:flex w-56 flex-col border-r border-white/8 bg-[var(--surface)] min-h-screen">
        <div className="p-5 border-b border-white/8">
          <a href="/admin" className="text-lg font-bold text-[var(--blue)]">
            vetor.blog
          </a>
      ...
      <main className="flex-1 min-w-0">
        <div className="md:hidden border-b border-white/8 bg-[var(--surface)] px-4 py-3 flex items-center justify-between">
          <a href="/admin" className="text-lg font-bold text-[var(--blue)]">
            vetor.blog
          </a>
