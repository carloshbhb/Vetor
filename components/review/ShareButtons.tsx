    ...
    <div className="flex items-center gap-2">
      ...
      {shareLinks.map(link => (
        <a
          ...
          onClick={link.name === 'Copiar Link' ? (e) => { e.preventDefault(); handleCopy(); } : undefined}
          className={`w-10 h-10 rounded-full bg-bg2 border border-border flex items-center justify-center text-text-muted transition-all ${link.color}`}
          title={link.name}
        >
